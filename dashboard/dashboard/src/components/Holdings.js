...
function Holdings() {
  return (
    <>
      <h4 className='title' style={{color:'#7b7a7a',margin:'1.5rem 0'}}>Holdings ({holdings.length})</h4>
  
      <div className='order-table' style={{color:'#7b7a7a'}}>
        <table style={{ border: '1px solid #eeeaea', width: '100%', border:'none'}}>
      ...
      <div style={{ display: 'flex', gap: '2rem', marginTop: '2rem' ,color:'#7b7a7a'}} >
        <div>
          <h2 style={{margin:'6rem'}}>29,875.<span>53</span></h2>
          <p style={{margin:'6rem'}}>Total Investment</p>
        </div>
        <div>
          <h2 style={{margin:'6rem'}}>31,428.<span>95</span></h2>
